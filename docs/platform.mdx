...
<Columns cols={3}>
  <Card title="React" icon="atom" href="/platform/sdks/react">
    Official React SDK for Novu's notification center.
  </Card>
  <Card title="JavaScript" icon="braces" href="/platform/sdks/javascript">
    Framework-agnostic JavaScript SDK for custom implementations.
  </Card>
  <Card title="React Native" icon="smartphone" href="/platform/sdks/react-native">
...
<Columns cols={3}>
  <Card title="Typescript" icon="braces" href="/platform/sdks/server/typescript">
    Connect your Node app to Novu via the TypeScript SDK.
  </Card>
  <Card title="Python" icon="code" href="/platform/sdks/server/python">
    Connect your Python app to Novu via the Python SDK.
  </Card>
  <Card title="Go" icon="code" href="/platform/sdks/server/go">
    Connect your Golang app to Novu via the Go SDK.
  </Card>
  <Card title="PHP" icon="code" href="/platform/sdks/server/php">
    Connect your PHP app to Novu via the PHP SDK.
  </Card>
  <Card title=".NET" icon="code" href="/platform/sdks/server/dotnet">
    Connect your C#/.NET app to Novu via the .NET SDK.
  </Card>
  <Card title="Java" icon="coffee" href="/platform/sdks/server/java">
    Connect your Java app to Novu via the Java SDK.
  </Card>
  <Card title="Kotlin" icon="coffee" href="/platform/sdks/server/kotlin">
    Connect your Kotlin app to Novu via the Kotlin SDK.
  </Card>
  <Card title="Laravel" icon="code" href="/platform/sdks/server/laravel">
    Connect your Laravel app to Novu via the Laravel SDK.
  </Card>
  <Card title="Ruby" icon="gem" href="/platform/sdks/server/ruby">
