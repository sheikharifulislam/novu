---
title: 'Angular In-App Notifications Quickstart — Novu Inbox'
description: 'Create an account and learn how to start using Novu Inbox in your Angular application.'
sidebarTitle: 'Angular'
---


Add real-time in-app notifications to Angular using the Novu Inbox component and the `@novu/js` SDK.
